...
public abstract class DAO {
    ...
    protected static void createTable() {
        ...
        try {
            //model.Animal
            query = DAO.connect().prepareStatement("CREATE TABLE IF NOT EXISTS Animal(ID INTEGER PRIMARY KEY, Name VARCHAR(255), Age INTEGER, Gender VARCHAR(255), Specie VARCHAR(255), IDClient INTEGER)");
            query.executeUpdate();
